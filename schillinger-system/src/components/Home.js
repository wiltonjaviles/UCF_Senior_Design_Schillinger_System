    ...
    <div>
      <Container>
        ...
        <TextToSpeech 
          ...
          his website was created as a senior design project for University of Central Florida's computer science program. Our team is Michael Alaniz, Wilton Aviles, Michael Duke, and Kathryn Wyrick. Our sponsor is Dr. Richard  lie necker.
          This project, once completed, will provide a comprehensive Schillinger System learning tool for musicians and software developers that can be used to create computer-assisted musical composition software. Since Schillinger never finished refining his ideas for the System it fell into obscurity after his death. This project aims to bring his system back to the forefront of musical composition. It could also provide substantial guidance for composers and software developers to implement Schillinger’s ideas.
          ...
          Michael Alaniz
          Full Stack Float
          Michael Alaniz is a Computer Science graduate from U C F, Spring 2021, and was a member of the first team to work on the Learn Schillinger project. He was in charge of the Web Server implementation, management, and a Full-Stack float. Michael enjoys playing the piano, music production, machine learning, and deep learning. LinkedIn
          Wilton Aviles
          Project Manager
          ...
          He enjoys coding, music, video games, basketball, and being a student of life. Wilton was involved with the Engineering Leadership and Innovation Institute at U C F (eli squared) as a Student Leader and Project Lead. LinkedIn
          Michael Duke
          ...
          She also designed and implemented the waveform and pendulum applets and implemented several of the applets in Book 1. She has been interested in music her whole life and can play (with varying degrees of success) the violin, piano, ukulele, ocarina, melodica, and trumpet. Her cat's name is Mow chi! After graduating, she has accepted a position with Lockheed Martin and will start working there in June 2021.
          "
        />
        <br />
        <h2>Introduction</h2>
