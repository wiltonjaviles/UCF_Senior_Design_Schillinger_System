...
function Introduction() {
  return (
    <div>
      <Container>
        <h1>Introduction</h1>
          <p class="bookText">Schillinger combined musical theory with recent findings in various scientific disciplines. He was the first to scientifically classify components of the musical system. Musical theory and science have been previously intertwined, dating back to Pythagoras, up to more modern musical theorists like Jean-Philippe Rameau and Helmholtz. Even so, mathematics and music has been a rare combination, considering the abstract nature of music and the strictness of mathematics. This cross has been a result of romanticism, thus being fairly recent in a historical context. One of Schillinger’s aims is to discover “general underlying principles” of the behavior of tonal phenomena. His contributions to theory, unlike his predecessors, is based on actual properties of music, and not deriving from previous theorists. Another one of Schillinger’s aims is to uncover and classify “all of the available resources of our tonal system”. The use of mathematics allows the task to be practical since it is of a great enough scope, unlike any other methodologies.</p>
          <p class="bookText">A third, and larger, goal is defined by Schillinger as a necessary corollary of the first two. “From the standpoint of science, analysis implies synthesis.” He is saying that the ability to break down a problem or structure into its main components implies the ability to reconstruct such things through synthesizing such elements. The argument is made that previous scientific approaches to musical theory were “partial in character”. It is said their generalizations were applicable to given aspects, not the art of composition as a whole.” Schillinger himself phrases his complete method as involving “the prefabrication and the assembly of components according to a reconceived design of the whole.”</p>
        <h5>Tools & Concept:</h5>
        ...
        <img src="../.././images/intro_image1.png"></img>
          ...
          <ol>
            ...
            <li class="bookText">Production of music from a system of number values translated into geometric relations and thereafter into corresponding components of the tonal art.” (25)</li>
          </ol>
        <h5>Schillinger's Masterful Pedagogy:</h5>
          ...
          <p class="bookText">Using this system, Schillinger arrived at 9 fundametal ideas:</p>
          <ol>
          ...
          <ol>
            ...
            <li class="bookText">Man recreates esthetic realities by reproducing the appearance of the physical realities through his own body or through a material at his command; this process involves mathematical logic regardless of whether the artist is conscious of it or not.  Imitating nature in an artistic medium, the artist achieves the laws of mathematical logic through his sensuous experience.  This is the intuitive period of art creation.</li>
