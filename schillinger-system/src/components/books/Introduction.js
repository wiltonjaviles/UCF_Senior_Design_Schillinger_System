  ...
  return (
    <div>
      <Container>
        ...
        3. Production of music from a system of number values translated into geometric relations and thereafter into corresponding components of the tonal art.” (25)
        ...
        <h5>Theory of Rhythm:</h5>
          ...
          <img className="img-fluid img-thumbnail" src="images/intro/img1.png" alt="image1"></img>
        ...
        <img className="img-fluid img-thumbnail" src="images/intro/img2.png" alt="image1"></img>
