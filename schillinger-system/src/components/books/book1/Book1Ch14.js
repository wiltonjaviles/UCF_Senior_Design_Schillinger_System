    ...
    <div>
      <Container>
        ...
        <TextToSpeech 
          ...
          Thus far, the methods for acceleration or deceleration apply to uniform rhythms (1 + 1 + 1 + 1…). Applying this method to non-uniform rhythms is straightforward: the group, A, is multiplied as a variable to each member of the series. So for example, the rhythm ā = (3 + 1 + 2) applied to a natural harmonic series would be 1ā + 2ā + 3ā + 4ā… or.
          Rubato.
