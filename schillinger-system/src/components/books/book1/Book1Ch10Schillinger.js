    ...
    <div>
      <Container>
        ...
        <TextToSpeech 
          ...
          Permutations of the higher orders based on the original group with 3 elements‘ (ā_1, b_1, c_1) offer the following combinations by 2: ā_1 + b_1, ā_1 + C_1, b_1 + C_1. These are the three possible alternatives when 2 elements out of 3 are used. The 2 elements form a group of 3, following the regulations described in the preceding paragraph concerning the higher orders of the 2 elements.
          The original group containing 3 elements has only one combination by 3:
          ā_1+ b_1+ c_1 The second order permutations on the 3 elements appear as follows:
          ā_1+b_1+C_1=ā_2
          ā_1+C_1+b_1=b_2
          C_1+ā_1+b_1=c_2
          b_1+ā_1+C_1=d_2
          ...
          Combinations by 6 :
          ā_2+b_2+C_2+d_2+e_2+b_2
          Total number of cases: 1 times 720 = 720
          All the recurring elements are eliminated from these charts, which may be consulted for coefﬁcients of recurrence. For example, a trinomial combination from 2 elements, ā1 and b1, with a coefﬁcient 2 for the ﬁrst element becomes 2ā_1 + b_1. This is a trinomial with 2 identical elements, and is subjected to circular permutations only. Similar cases occur with 4 elements having 2 identical terms, 2 identical pairs or 3 identical terms. Similar cases occurring with 5 and 6 elements may contain 2, 3 and more identical elements. They will be treated as coefficients of recurrence.
          Example:
