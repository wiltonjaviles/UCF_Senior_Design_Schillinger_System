  ...
  return (
    <div>
      <Container>
        ...
        <TextToSpeech 
          text="
          CHAPTER 10. GENERALIZATION 0F VARIATION TECHNIQUES
          ...
          Moving for 8 more bars, i.e., carrying out the permutations of the 4th order to their completion, we obtain 16 bars containing great variety as compared to the usual continuous recurrence. This device is particularly useful when the character of music must be retained for considerably longer time than the original rhythmic group permits. Instead of making continuous repetitions of the original group, or recurrences of the larger groups, it is possible with this device to go on continuously for an indeﬁnite period of time.
          In musical backgrounds for motion picture photoplays, when the scene develops in a deﬁnite locality—associated with deﬁnite rhythmic forms of expression, it may be desirable to extend this homogeneous rhythmic character to 10 or 15 minutes. In the case of a Cuban scene, rhumba rhythms are considered characteristic of the locality. The audience is distracted from action on the screen by the musical background when a deﬁnite dance composition is played repeatedly. This annoys the audience and never helps to bring out the dramatic plot. 0n the contrary, it produces conflicts with the plot. A neutral background, being homogeneous and yet continuously varied, will serve the purpose much better.
          Permutations of the higher orders based on the original group with 3 elements‘ (ae_1, b_1, c_1) offer the following combinations by 2: ae_1 + b_1, ae_1 + C_1, b_1 + C_1. These are the three possible alternatives when 2 elements out of 3 are used. The 2 elements form a group of 3, following the regulations described in the preceding paragraph concerning the higher orders of the 2 elements.
          The original group containing 3 elements has only one combination by 3:
          ae_1+ b_1+ c_1 The second order permutations on the 3 elements appear as follows:
          ae_1+b_1+C_1=ae_2
          ae_1+C_1+b_1=b_2
          C_1+ae_1+b_1=c_2
          b_1+ae_1+C_1=d_2
          ...
          Combinations by 6 :
          ae_2+b_2+C_2+d_2+e_2+b_2
          Total number of cases: 1 times 720 = 720
          All the recurring elements are eliminated from these charts, which may be consulted for coefﬁcients of recurrence. For example, a trinomial combination from 2 elements, ae1 and b1, with a coefﬁcient 2 for the ﬁrst element becomes 2ae_1 + b_1. This is a trinomial with 2 identical elements, and is subjected to circular permutations only. Similar cases occur with 4 elements having 2 identical terms, 2 identical pairs or 3 identical terms. Similar cases occurring with 5 and 6 elements may contain 2, 3 and more identical elements. They will be treated as coefficients of recurrence.
          Example:
