    ...
    <div>
      <Container>
        ...
        <TextToSpeech 
          ...
          ANY rhythmic group may be adapted to the processes of growth in simultaneity and continuity. There are three fundamental procedures, varying with regard to the quantity of material to be evolved. The first process gives the minimum quantity; the second, the intermediate; and the third, the maximum quantity. Select them in accordance with the requirements of each specific case
          (1) We may produce elements from a given rhythmic group by means of splitting the group through the simplest divisor. For example, the group r4÷ 3(grouped by 4) represents a 4- bar continuity in 4 4 time. four---may be divided by 2 and thus we obtain two groups: ae 1 comprising the first two- bars, and b1 comprising the second two bars. This gives us an 8-bar, 2-part continuity, i.e., the quantity of the original material is doubled both in simultaneity and continuity
          When a group is not divisible by 2, like r5÷3 (grouped by 5), it may become divisible by 3. In this case it produces 3- bars in 5 4 , 5 8, or any other quintuple time. the first bar being ae 1, the second b1 and the third c1.
          (2) We may produce elements from a given rhythmic group by means of splitting it through individual bars. For example, in r4÷3 grouped in 4- bars, each individual bar becomes an element. The first is ae 1, the second b1, the third c1, and the fourth d1. This splitting process produces a 16-bar continuity in 4 parts, ie, both simultaneity and continuity of the original group become quadrupled.
          This continuity is the result of circular permutations. Using general permutations for this group, and splitting it in this particular fashion, we obtain 4- bars in 4 parts with 24 different variations, i.e., 96- bars in 4 parts. In a case in which the simplest divisor corresponds to the splitting by individual bars,as in the above-mentioned case of r5÷3, this becomes the only possible procedure.
