  ...
  return (
    <div>
      <Container>
        ...
        Musically, the first case establishes a bar in which the musical numerator is 2, i.e., 2/2(¢), 2/4, 2/8. When the bar is 2/2, 1/2= ;when the bar is 2/4, 1/2= when the bar is 2/8, 1/2 = 
        Second Case
        3÷ 1
