  ...
  return (
    <div>
      <Container>
        ...
        (2) to find complementary factors of both generators; the complementary factor of ae is ae b/ae = b, and the complementary factor of b is ae b/b = ae.
        ...
        Complementary factor of ae 2/2=1 1(2).
        ...
        (2) Superimposition Of ae. ae= 3. In order to get the reality of such superimposition, op. must be excluded and b becomes merely an optional
        ...
        Take, for example, a figure ae/4; it is r3÷ 2. Take C; it is two-thirds of the r4÷ 3.
