  ...
  return (
    <div>
      <Container>
        ...
        A periodicity consisting of greater number values will be denoted by the term, ‘major generator’ the smaller of the two will be called,‘ minor generator’ The way in which we will express two synchronized generators producing one interference-group is ā÷b. The expression for the resultant of interference is r ā ÷b.
        ā. BINARY SYNCHRONIZATION

        To synchronize two monomial periodicities it is necessary:.
        (1) to find common product or common denominator (c.p. or Cd.)
        (2) to find complementary factors of both generators; the complementary factor of ā is ā b/ā = b, and the complementary factor of b is ā b/b = ā.
        ...
        T = r ā÷1.
        (read: musical bar(T) is the resultant of ā to one.).
        First Case.
        2 ÷ 1
        Find the resultant, r2÷1.
        Common product (c.p.) 2x1 = 2.
        Complementary factor of ā 2/2=1 1(2).
        Complementary factor of b 2/2=2 2(1/2).
        ā consists of two’s.
        b consists of one’s.
        Although Schillinger here and elsewhere uses the division sign to indicate the a and b division  relationship (ā÷b), it should be noted that Schillinger on other occasions uses a colon in place of the division sign (ā:b).
        Neither the colon nor the division sign is employed as in ordinary arithmetic. 4:3 means in ordinary arithmetic, 4 divided by 3 or 4/3 and 4 ÷ by 3 means the same. In Schillinger’s use of these signs, neither a ratio nor division is meant. He meant interference by them, the full mathematical formula for which is ā:b=b+(ā-b)+(2ā-2b)+(2ā-2b)+(2ā-2b)+(ā-b)+b…. In arithmetic 4:3 In Schillinger 4:3 
        ...
        (2) Superimposition Of ā. ā= 3. In order to get the reality of such superimposition, op. must be excluded and b becomes merely an optional
        (3) Superimposition of b. b= 2; c.p. is excluded: ā becomes optional.
        4 ÷ 3
        ...
        All these diagrams represent the natural nucleus of a musical score, in which c.d. units are arpeggio or obligato figures, ā and b are chords, ,r rhythms of the theme, and c.p. sustained  tones (pedal point). The resultants have the following characteristics:
        ...
        Take, for example, a figure ā/4 ;it is r3÷ 2. Take C  ;it is two-thirds of the r4÷ 3.
        When all the resultants up to ā = 9 have been found, one can obtain all the patterns of the past and present, and, to some extent, of the future.
        ...
        When c.p. is greater than 15, use ā and b superimposition only.
        ...
        The ā and b components present a clear idea of how cross-rhythms should be performed. Beating ā and b with both hands, listen to the resultant, i.e., playing 3 against 2,play one—two, one, one, one-two (2 + 1 + 1 + 2 = ), alternating hands.
