    ...
    <div>
      <Container>
        ...
        <a className="chapter-section-link" href="/book1ch7#1.7.a" id="1.7.a"><h5>A. Instrumental Rhythm</h5></a>
          ...
          <img className="img-fluid img-thumbnail" src="images/book1/ch7/img1.png" alt="book1ch7img1"></img>
          <br /> <br />
          ...
          <img className="img-fluid img-thumbnail" src="images/book1/ch7/img2.png" alt="book1ch7img2"></img>
          <br /> <br />
        ...
        <a className="chapter-section-link" href="/book1ch7#1.7.b" id="1.7.b"><h5>B. Applying the Principles of Interference to Harmony</h5></a>
          ...
          <br /> <br />
          <p class="bookText">The following illustrates the continuous run of these instrumental forms of harmony with various simpler rhythmic resultants, all used one chord:</p>
          <Ch7Generator />
          ...
          <img className="img-fluid img-thumbnail" src="images/book1/ch7/img11.png" alt="book1ch7img11"></img>
          <br /> <br />
          ...
          <img className="img-fluid img-thumbnail" src="images/book1/ch7/img12.png" alt="book1ch7img12"></img>
