    ...
    <div>
      <Container>
        ...
        <a className="chapter-section-link" href="/book1ch1#1.1.a" id="1.1.a"><h5>A. Graphing Music</h5></a>
          ...
          <img className="img-fluid img-thumbnail" src="images/book1/ch1/img3.png" alt="book1image3"></img>
        ...
        <a className="chapter-section-link" href="/book1ch1#1.1.b" id="1.1.b"><h5>B. Forms of Periodicity</h5></a>
          ...
          <img className="img-fluid img-thumbnail" src="images/book1/ch1/img4.png" alt="book1image4"></img>
