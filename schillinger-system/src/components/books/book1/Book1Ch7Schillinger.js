    ...
    <div>
      <Container>
        ...
        <TextToSpeech 
          ...
          r3÷2
          This technique makes it possible to run a very simple motif practically to inﬁnity, as the duration of continuous variability depends solely on a common denominator. A simple example of rhythmic continuity through instrumental interference may be found in many arrangements of fox-trots. The ﬁgure of 6 uniform attacks (two false triplets) placed in a common time measure (=8/8)produces an interference of 8÷6. 8÷6 reduces to 4÷3. Six acquires the complementary factor 4, and 8 acquires the complementary factor 3, i.e., the instrumental ﬁgure with 6 attacks runs 4 times in the course of 3 8 8 measures.
          ...
          (1) The two~attack instrumental ﬁgure (as in the polka). The ﬁrst attack is the detached bass of harmony. The second attack includes all the remaining upper parts of a Chord.
          (2) The four-attack instrumental ﬁgure (as in the fox-trot). The ﬁrst attack is the lower bass. The second attack, the upper part of the chord. The third attack is another detached bass. The fourth attack, the upper part of a chord.
          (3) The six-attack instrumental ﬁgure (as in the rhumba). The ﬁrst attack is the lower detached bass. The second attack is the upper part of the chord. The third attack is the middle detached bass. The fourth attack is the upper part of the chord. The ﬁfth attack is the upper detached bass. The sixth attack is the upper part of the chord.
          (1) (2) (3)
          It is easy to see that the waltz accompaniment ﬁgure is merely (1) above, with the upper chord having two attacks instead of one. The old tango and habanera ﬁgures are like (2), except that the last attack is made on the lower bass.
