    ...
    <div>
      <Container>
        ...
        <TextToSpeech 
          ...
          R3÷2
          Taking the same case of the two kettle drums for r 3÷ 2, we get a totally different resultant. The number of attacks in the instrumental group remains the same (2). 
          The number of terms in the rhythmic resultant is 7, (2 + 1 + 1 + 1+1 + 1+ 2). 7 times 2 = 14. Seven has a complementary factor 2, and 2 has a complementary factor 7. 
          The kettle drum 2 attack figure will appear 7 times, while the rhythmic resultant appears twice.
          Here we see the first of what will come to be a great many examples of the way in which Schillinger’s theory of rhythm goes much further than the simple question of time rhythm. 
          Note that Schillinger here states that instrumental rhythm is one thing (that is, the pattern according to which instruments enter or drop out of the ensemble) and time rhythm is another (that is, the pattern according to which the sounds are produced, regardless of which instruments are producing these sounds). Schillinger here discusses the application of his theory not only to the rhythm of the sounds produced, but also to the allocation of parts among various instruments.
          This principle may be carried out to any desired degree of complexity, depending on the common denominator between the number of terms in a rhythmic group and the number of attacks in an instrumental group. 
          The difference between two kettle drums and any melody or any instrumental form of harmony (accompaniment) with respect to this calculation is merely a quantitative difference.
          Let us take a motif consisting of four different pitches, (for example: c, d, e, f); such sequence of pitches is merely one of the possible forms of melody. But superimposing r3÷2 we obtain one group without recurrence because the number of pitches (intonation attacks), and the number of terms in the rhythmic resultant (time attacks), are equal (4÷ 4=1).
          Taking the same four notes of the melody and superimposing r3÷2 we get 7 times 4=28. The rhythmic group having 7 attacks acquires the complementary factor 4, i.e., it will run 4times until its own recurrence, while the melody having 4 attacks will acquire the complementary factor 7, i.e., it will run 7 times until its own recurrence will coincide with the recurrence of the rhythmic resultant.
          r3÷2
          ...
          4 times 3: 12 attacks
          2 (2+3+3)
          [Rhumba]
          2 (3 + 3+ 2)
          The preceding technical items may also be treated in combination. The following example represents the application of two generators and their resultants, combined with the instrumental interference. The accompaniment represents the minor generator (2). The sustained chords represent the major generator (5). 
          The melody represents the resultant (5÷2). In addition, the whole score is carried out through an alien measure grouping, in While the entire rhythmic score would occupy 4- bars in 5 4 time, it takes 5- bars in 4 4 time. This example illustrates the possibility of introducing various rhythmic resultants into music which is supposed to be written in common time.
