    ...
    <div>
      <Container>
        ...
        <Speech 
          ...
          2. Find complementary factors of both generators; the complementary factor of ā is (a b)÷a=b, and the complementary factor of b is (a b)÷b=a.
          ...
          *note: sometimes Schillinger uses ÷ to indicate the a and b relationship, but also sometimes uses colon to indicate the relationship instead. These both mean interference
          ...
          When it comes to the application of higher numerators (5, 7, 11, etc) that the music becomes incomprehensible to the average listener and the composer is the one to blame. When it comes to the shifting of accents which aren’t correctly expressed (through a and b), the performance suffers and listeners are confused.
          ...
          When all of the resultants up to a = 9 have been found, you can create all rhythm patterns in the past, present, and even the future.
          ...
          The a and b components show how ‘cross-rhythms’ should be performed. Beat a and b with both hands, listen to the resultant.
          " 
        />
        ...
        <a className="chapter-section-link" href="/book1ch2#1.2.a" id="1.2.a"><h5>A. Binary Synchronization</h5></a>
          ...
          <img className="img-fluid img-thumbnail" src="images/book1/ch2/img1.png" alt="book1image6"></img>
          ...
          <img className="img-fluid img-thumbnail" src="images/book1/ch2/img2.png" alt="book1image7"></img>
          ...
          <img className="img-fluid img-thumbnail" src="images/book1/ch2/img3.png" alt="book1image8"></img>
          <p class="bookText">This case shows musical bars with 3 as a numerator. I.e.: </p>
          <img className="img-fluid img-thumbnail" src="images/book1/ch2/img4.png" alt="book1image9"></img>
          <p class="bookText">A third example:</p>
          <img className="img-fluid img-thumbnail" src="images/book1/ch2/img5.png" alt="book1image10"></img>
        ...
        <a className="chapter-section-link" href="/book1ch2#1.2.b" id="1.2.b"><h5>B. Grouping</h5></a>
          ...
          <img className="img-fluid img-thumbnail" src="images/book1/ch2/img13.png" alt="book1image18"></img>
