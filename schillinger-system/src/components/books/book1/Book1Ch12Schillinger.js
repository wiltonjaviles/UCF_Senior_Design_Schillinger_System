    ...
    <div>
      <Container>
        ...
        <TextToSpeech
          ...
          This is an idea fundamental to Schillinger’s system. He does not regard what is ordinarily called musical form— i.e., the organization of the entire composition by phrases, etc. as something separate from the rhythms of the measures themselves.
          Rather, he regards the two — fractional (rhythms within the measure) and factorial (rhythms of the measures)—as two aspects of the same central situation.
          For example the algebraic square of ae  + b is: ae (squared) + 2 ae b + b. But the distributive square would be  ae (squared) + ae b + ae b + b(squared). In other words, the magnitudes are distributed rather than being grouped after coefficients. The use by Schillinger of distributive powers is one of the most extraordinary aspects of his system; these are used as well in other arts, especially in the spatial arts.
          ...
          See Chapter 1 of Theory of Rhythm. See also Chapter 2 of Book IV, Theory of Melody which presents a history of musical notation and fully describes the inadequacy of the accepted system of notation that caused Schillinger to search for a new system.
          Classical music developed very little efficiency in the 3 3 series. The right side is entirely untouched, because when we find 3-bar phrases in such music, it is usually a 4-bar or 2-bar phrase—modified by means of expansion or contraction. The left side of the 3 3 series is somewhat better developed. There are- bars with three beats (3 4 time), there are- bars with nine beats (9 8 time), and there are even a few rare cases when 27 16 appears as a musical measure, as in some works of J. S. Bach. If music has been developed so consistently up to the seventh power on the determinant 2 2, why should it not develop with the same consistency on any other determinant in use. Why has the 3 3 series reached only its cube, and that only on very rare occasions Why has it not developed beyond the first power on the factorial side. The answer is obvious: it is the system of musical notation attached to the 2 2 determinant that has caused this conservatism.
          ...
          Classical music of the past evolving from the series with the 3 3 determinant, deviating from the natural consistency of powers, resorts to simplification. The common case of music written in 3 4 time is not a quarter-note split into a triplet of eighths but into two eighths. This means that 1 3 instead of being multiplied by 1 3; and becoming 1 9 is multiplied by 1 2 and becomes 1 6. This is typical of a hybrid resulting from unintentional simplification. The eighth in 3 4 time more frequently becomes  , and not  as it should.
          ...
          If the former were true, one could not find any pure folk music with any other form of fractional development than that (achieved through the determinant 2. Yet the music of Hindustan, very old and very traditional, uses a great many triplets representing a split-unit group of one beat in 5 4 time  This shows that the 5 5 determinant, which is characteristic of many old Asiatic civilizations, acquires its simplified fractioning through the 3 3 series, i.e.,1 5 times 1 3 = 15.
          ...
          (American Library of Musicology, 19 32).
          The present state of development of the 5 5 series is still very elementary. Five-bar groups are as rare as the quintuplets in 5 5 time. It is difficult now to make’ a definite statement on the origin of the 5 5 series. It may have been influenced by the forms of poetical rhythm known as pentameter; and it may have been influenced by the very same factors that influenced the formation of a pentacle in starfish.
          ...
          The method of distributive powers offers a solution for producing harmonic contrasts developed from the original polynomial ratio. This solves the problem of composing counterthemes to any theme, whether the contrast appears in simultaneity (counterpart) or continuity (sequence). The law of distributive powers is a common esthetic law of proportionate distribution of harmonic contrasts.
          ...
          Fractional binomials: 2 thirds + 1 third and 1 third and 1 third +2 thirds.
          (Squaring).
          (synchronization).
          (squaring).
          (synchronization).
          ...
          6 ninths + 3 ninths and 4 ninths + 2 ninths +2 ninths +1 ninth in continuity.
          ...
          In addition to this, it is important to supplement the score by r ae÷b where a is the determinant of a series. For example, in the foregoing case the determinant is 3; therefore r3÷2 may be added to the score.
          Here is a complete graph and musical notation of the power groups, their resultants and r ae÷ b.
          ...
          As in the case of binomials, it is desirable to supplement this score by the first and second power resultants and the r ae÷ b.
          ...
          III. Generalization of the Square (Any Polynomial).
          Formula.
          ...
          Synchronization.
          This is the square of the real hot rhythms and it has the utmost plasticity. Nobody realizes, listening to this, that the eight- bars are over.
          Any bar of 4 4 treated as 8 8 will give a perfect countertheme for 8- bars. Take, for example, the song used earlier, Pennies from Heaven.  Copyright 1936 by Sandy-Joy, Inc., New York, U.S.A. Reprinted by permission of the publishers.
          ...
          1+2+1+2+2.
          1+2+2+1+2.
          VII. Generalization of All Powers (Any polynomial to any power).
          ...
          The procedure remains the same. To obtain the distributive power of any group, it is necessary to obtain the distributive n minus 1 power of the same group, multiply each term of such group by the terms of the first power group consecutively, and then add the products in sequence.
          If G stands for a group, this may be expressed through the formula.
          To synchronize the first power group with the  power group, it is necessary to multiply each term of the first power group by the quantitative n minus 1 power of the same group To synchronize the second power group with the power group, it is necessary to multiply each term of the second power group by the quantitative n minus 2 power of the same group, etc.
