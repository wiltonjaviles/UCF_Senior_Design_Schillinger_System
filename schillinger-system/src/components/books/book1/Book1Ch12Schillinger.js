    ...
    <div>
      <Container>
        ...
        <TextToSpeech
          ...
          problems. Esthetic problems are essentially the problems of distribution and coordination, and not problems of mere quantity. The process of evolving any initial ratio through its own factoring lies within the ﬁeld of distributive powers. The distributive powers organize not Only the value but also the quantity of the values harmonically. Any binomial under distributive powers becomes a quadrinomial on the square (2 squared = 4). It becomes a group of 8 terms on the cube; 3. trinomial becomes a polynomial with 9 terms on the square (3 squared= 9)..
          ...
          Classical music developed very little eﬁiciency in the 3/3 series. The right side is entirely untouched, because when we ﬁnd 3-bar phrases in such music, it is usually a 4-bar or 2-bar phrase—modiﬁed by means of expansion or contraction. The left side of the 3 3 series is somewhat better developed. There are bars with three beats (3 4 time), there are bars with nine beats (9 8 time), and there are even a few rare cases when 27 16 appears as a musical measure, as in some works of J. S. Bach. If music has been developed so consistently up to the seventh power on the determinant 2 2, why should it not develop with the same consistency on any other determinant in use? Why has the 3 3 series reached only its cube, and that.
          only on very rare occasions? Why has it not developed beyond the ﬁrst power on the factorial side? The answer is obvious: it is the system of musical notation attached to the 2 2 determinant that has caused this conservatism.
          Racial and national instincts in music, in contrast to acquired musical theories, work with much greater consistency although evolution by this means often requires centuries. Some of the American Indians, for example, exhibited such a degree of consistency with regard to the 3 3 series. Their evolution did not reach high powers, yet these Indians are uniformly consistent as to both the factorial and fractional side. They use the ﬁrst, the second, and the third powers of the above-mentioned series—see the musical example in Helen Roberts’ book, Form in Primitive Music, page 39.
          The 4 4 series, being a multiple of the 2 2 determinant, does not exhibit strikingly new characteristics. We ﬁnd such music frequently in many compositions. Groups like 4 + 1 + 1 + 1 + 1 may be found in any music entitled March.  The accumulation of bars in groups of 4 and 16 is also quite common.
          Classical music of the past evolving from the series with the 3 3 determinant, deviating from the natural consistency of powers, resorts to simpliﬁcation. The common case of music written in 3 4 time is not a quarter-note split into a triplet of eighths but into two eighths. This means that 1 3 instead of being multiplied by 1 3; and becoming 1 9 is multiplied by 1 2 and becomes 1 6. This is typical of a hybrid resulting from unintentional simpliﬁcation. The eighth in 3 4 time more.
          frequently becomes  , and not  as it should.
          This tendency toward simpliﬁcation is philosophically puzzling. We must ask: is this number 2 an unavoidable condition in evolving any series, as in the multiplication of spermatozoa and other microbes and lower organisms? Or is the determinant 2 not as vital as it may seem at ﬁrst, merely serving as an outlet for simpliﬁcation?.
          If the former were true, one could not ﬁnd any pure folk music with any other form of fractional development than that (achieved through the determinant 2. Yet the music of Hindustan, very old and very traditional, uses a great many triplets representing a split-unit group of one beat in 5 4 time  This shows that the 5 5 determinant, which is characteristic of many old Asiatic civilizations, acquires its simpliﬁed fractioning through the 3 3 series, i.e.,1 5 X 1 3 = 15.
          ...
          The present state of development of the 5 5 series is still very elementary. Five-bar groups are as rare as the quintuplets in 5 5 time. It is difﬁcult now to make’ a deﬁnite statement on the origin of the 5 5 series. It may.
          have been inﬂuenced by the forms of poetical rhythm known as pentameter; and it may have been inﬂuenced by the very same factors that inﬂuenced the formation of a pentacle in starﬁsh.
          ...
          (a) Factorial:.
          (b) Fractional:.
          To obtain the distributive second power of a binomial, it is necessary to multiply the ﬁrst term of a binomial by itself, then by the second term; then the second term by the ﬁrst, then the second by the second.
          Formula for Synchronization.
          (a) Factorial: =.
          (b) Fractional: .
          To synchronize the initial binomial with its distributive square, it is necessary to multiply the ﬁrst term by the sum of the binomial, then the second term by the sum of the binomial.
          Example.
          ...
          In order to synchronize any initial polynomial with its distributive square, it is necessary to ﬁnd the products of each term by the sum of the polynomial. For example, to synchronize a trinomial with its distributive square.
          Series.
          figure 131.
          ...
          As in the case of binomials, it is desirable to supplement this score by the ﬁrst and second power resultants and the ra÷ b.
          Here is the entire score.
          figure 132.
          It is interesting to note that in this particular case, i.e., 2 + 1 + 1 and 1 + 1 + 2, classical composers found intuitively the exact distributive squares. As you can see from this score, they could not ﬁnd the square of 1 + 2 + 1. This ﬁgure, i.e., (1 + 2 + 1) + (2 + 4 + 2) + (1 + 2 + 1), or assuming 1 16 =  is very practical for the tango.
          Chart of Trinomials.
          ...
          l + 2 + 1 + 2 + 2.
          1 + 2 + 2 + 1 + 2.
          The following is an illustration of the ﬁrst one.
          Synchronization.
          Figure 133.
          ...
          Any bar of 4 4 treated as 8 8 will give a perfect countertheme for 8 bars. Take, for example, the song used earlier, Pennies from Heaven.* The ﬁrst bar (it may be any bar) is , i-e. 3+1+2+2. It is now squared in order to obtain a countertheme for the ﬁrst eight bars.
          (3+1+2+2)^2=(9+3+6+6)+(3+1+2+2)+(6+2+4+4)+(6+2+4+4).
          Theme.
          Counter-Theme.
          Figure 134.
          IV. Cube of a Binomial.
          Cubes produce a new degree of harmonic contrasts. Distributive cubes serve as a new countertheme to the groups of the ﬁrst and the second power with which they will be synchronized. Cubes are related to squares as the squares are related to the ﬁrst powers. The number of terms in a distributive binomial of the third power equals. The recurrence of the central binomial is an invariant of a distributive binomial of the third power.
          To obtain the distributive third power of binomials, multiply the distributive second power binomial by the ﬁrst term of the ﬁrst power binomial, then by the second term of the ﬁrst power binomial, and add the products in the same sequence.
          Formula.
          The denominator is the quantitative cube of the sum.
          To synchronize the distributive square with the distributive cube, it is necessary to multiply each term of the square by the sum of the ﬁrst power binomial.
          To synchronize the ﬁrst power binomial with its distributive cube, it is necessary to multiply each term of the ﬁrst power binomial by the square of the sum of the binomial.
          ...
          Synchronization of the ﬁrst power with the cube.
          1 + 2 gives the converse of these groups. Assuming,.
          we obtain 3 bars in 9 8 time.
          This produces three harmonically contrasting pairs. Using the ﬁrst, the second and the third power groups in sequence, we obtain a harmonically growing animation.
          ...
          The procedure remains the same, i.e., each term of second power groups must be multiplied consecutively by each term of the ﬁrst power groups, and the products added in sequence.
          Formula.
          The denominator equals the quantitative sum of the trinomial cubed.
          Synchronization of the ﬁrst and the second power trinomials with the distributive third power trinomial must be performed by consecutive multiplication of each term of the ﬁrst power trinomial by the square of the sum of its terms and for synchronization of the square—by the sum of its terms.
          Example.
          Synchronization of the square.
          Synchronization of the ﬁrst power.
          Assuming.
          Figure 136.
          Trinomials to be cubed and synchronized with their second and ﬁrst power groups.
          VI. Generalization of the Cube.
          (Any Polynomial).
          To obtain the distributive cube of any group (polynomial) it is necessary to obtain the distributive square ﬁrst, and multiply all its terms by the terms of the ﬁrst power polynomial consecutively; then add the products in sequence.
          Formula.
          ...
          The procedure remains the same. To obtain the distributive power of any group, it is necessary to obtain the distributive n - 1 power of the same group, multiply each term of such group by the terms of the ﬁrst power group consecutively, and then add the products in sequence.
          If G stands for a group, this may be expressed through the formula.
          To synchronize the ﬁrst power group with the  power group, it is necessary to multiply each term of the ﬁrst power group by the quantitative n-1 power of the same group To synchronize the second power group with the power group, it is necessary to multiply each term of the second power group by the quantitative n-2 power of the same group, etc.
