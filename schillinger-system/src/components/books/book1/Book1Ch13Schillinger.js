  ...
  return (
    <div>
      <Container>
        ...
        Formula.
        i sub n = 2 n t sub (n-1) - 1.
        The number of terms in the nth interference-group equals the product of the number of terms in the n - 1^st> interference-group by 2, minus 1.
        Example.
        The ﬁrst interference-group i sub 1 = 2.
        The second interference-group i sub 2 = (2 times 2) - 1 = 3.
        The third interference-group i sub 3 = (2 times 3) - 1 = 5.
        The fourth interference-group i sub 4 = (2 times 5) - 1 = 9.
        The ﬁfth interference-group i sub 5 = (2 times 9) - 1 =17.
        ...
        As previously mentioned, the original (binomial) interference-groups may be obtained directly from a determinant For example, the distribution of a determinant 5 gives 3 + 2 and 4 + 1, and their permutations. These binomials are the ﬁrst and the last binomials of the resultants obtained from two uniform monomial generators in which the determinant of a series is a major generator (a).
        Therefore, 3 + 2 are the ﬁrst two terms of a resultant where a = 5; 4 + 1 are the last two terms of a resultant where a = 5.
        ...
        5 + 3 = 8    
        The determinant is M 8 8.
        Find the a and b generators.
        b = 5
        a = 5 + 3 = 8.
        The binomial represents the ﬁrst two terms of r 8 5.
        Existing music often works on more than one determinant, thus producing various hybrids. It is very easy to trace the origin of any rhythmic hybrid, as such groups which are alien to the family are indicated in musical notation by the numbers. For instance, the triplets in M 4/4 time; the duplets M 3/4 time, etc. 
        ...
        In the light of such a hypothesis, the origin of the  Charleston 5 + 3 binomial may be explained as a tendency to disturb the balance of M 2/4+M.2/4 in M 4/4 or M 4/8+M.4/8 in M 8/8.
        Chronologically, the more unbalanced binomials (such as M 7 8 + M 1 8) appear later than the balanced ones (such as M 5 8 + 3 8), regardless of their structural complexity. While 5 + 3 has been known in the American dance-music for some time, 1 + 7 appeared as a prominent pattern only with the song,  Organ Grinder’s Swing.
        The prediction of new rhythmic families to come is based on the principle of the growth- through-power series.
        So far we have had, during the entire range of recorded history, the evolution of M 2 2 into its second power M 4 4, and into its third power M 8 8. Most probably M 9 9 will take its place in the near future as the second power of M 3 3; The series, M 6 6 is an exhausted European hybrid, being the product of 2 X 3. The M 5 5 and M 7 7 series are Oriental series of old origin. They may become fashionable for a while in the Western musical world.
        Thus, the series of factorial-fractional continuity express the evolutionary forms in the two-coordinate system.
        A. SWING MUSIC.
        The following is an analysis of the phenomenon known as swing music; it is an analysis of  swing as it is performed, not as it is written out on paper. In view of the fact that triplets of eighths in common time are very prominent in this type of playing, particular attention must be given to the value 3, its multiples and its powers. Knowing from the previous analysis that M 9 9 is the most probable candidate for the new style, I have studied all the  waltz-like phenomena which have appeared during the last few decades. The utmost plasticity of the Viennese type of waltz (such as the waltz from Rosenkavdlier by Richard Strauss) is due to this ﬁgure.
        The above is 3 + 1 + 5 + 1 + 5 + 1 + 2 etc., where the characteristic grouping is one appearing between the two ﬁves.
        The trinomial 4 +1 + 4 can be found in the second interference group in the M 9 9 series. Here again (as in the case of powers) is the intuitive approximation of the correct patterns. The waltz pattern is  trying to evolve into its second power. The idea of unity between the two greater number-values is right, but the number-values are only approximately correct.
        There are other hybrids which are characteristic of Viennese waltzes. For example, a hybrid between M 3 3 and M 4 4 series. 3 + 1 coming from M 4 4 series and placed into M 6 6 series (M.3 4 time).
        Most jazz ( Charleston Rhythm) 'is a hybrid between M 8 8 and M 6 6 series.
        Examine the following.
        And so, too, with all patterns of M 6 6 series put into M 8 8 time.
        The original binomial of this style is most characteristic of Viennese waltzes.
        Also the trinomial of M 6 6 series. 1 + 1 + 4,
        See Rosenkavalier.
        This, being placed into M 8 8 time, produces.
        An approach to the M 9 9 family from another angle is swing.The foundation of the latter is the foxtrot in triplets. Rhythms of M 4 4 and M 8 8 are modiﬁed on a basis of M 12 12 or M 12 8 and M 4 4 (in triplets) musically.
        The common denominator units are the eighths.
        Through syncopation tendencies, plus the M 3 3 series binomial, we obtain all the possible patterns of  swing.
        ...
        It is interesting to note that, even in bands such as Benny Goodman’s, all orchestral parts are written either in the M 4 4 series patterns or M 8 8 series patterns, but are then translated into  swing while being played. line 4, is the ﬁrst true pattern of a M 9 9 series trinomial (4 + 1 + 4). This pattern, with greater consistency, would appear as in line 4a. The number-values are correct but the group unit is wrong. It is applied in the wrong type of measure, M 12 12 instead of M 9 9.
        Thus, we can see that both the Viennese waltz and the fox-trot are engaged in a struggle for crystallization of the M 9 9 family.
        All rhythmic interference groups have as the only alternatives in their evolution. either to evolve the higher powers of the some patterns, or to evolve into the higher powers of the same determinant.
        ...
        The ﬁrst resultant (r sub 1) produces its permutations (P r sub 1) which form the ﬁrst interference-group; these being synchronized (S P r sub 1) produce the ﬁrst interference. The resultant of this interference is the second resultant (r sub 2), etc.
