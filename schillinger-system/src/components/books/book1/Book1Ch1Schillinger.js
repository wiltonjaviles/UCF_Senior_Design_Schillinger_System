    ...
    <div>
      <Container>
        ...
        <TextToSpeech 
          ...
          If, from experience outside the musical field, you already know how graphs are used, it will be sufficient to say at this point that (ae) music can be graphed by allowing the lengths of a number of horizontal lines to stand for the duration of tones, and causing the distance up or down (ordinate) to stand for the pitch levels of the tones; and (b) when graphing duration only, as in these studies, the end of one duration and beginning of the next may be indicated by a ‘tum’ (phase change) in the line, as shown in Figure 47.
          ...
          The general form of the analysis of wave—motion is the Fourier method which Fourier developed in 1822' for the purpose of analyzing heat—waves. This method is very precise. It is used in all fields dealing with oscillatory phenomena. Yet it is a very complicated method to use for the purpose of analyzing the music of human performers. It takes about twelve hours to analyze a wave of thirty components. Machines known as harmonic analyzers have been devised. These machines perform the work of an expert mathematician in about ten minutes without any possibility of error. They are used in various fields of physics and in meteorological departments, mainly to predict tidal variations.
          ...
          where a is the recurring monom and where t1, t2 . . . are the consecutive time moments; a may assume different values. In the field of musical time durations these values are integers; a may equal 1, 2, 3, . . . n.
